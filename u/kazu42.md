...
ソフトウェア研究開発者。
動画配信プラットフォームで主にサーバーサイドの研究開発に従事。その他にもセキュリティ対策やApple Vision Proネイティブアプリ開発などでリードを務める。
・いくつかの国内最大規模のTech Conferenceに主催メンバーとして関与
・2022年42Tokyo入学
・2023年に米国Google LLCにてSWEとしてインターン
・2024年 Alpha+ Project 2期生
カンファレンスでは、セッション採択をはじめ、Live配信システムやNetworkシステムの内製、DEIの分野でディレクターを務める。
教育・エンターテイメント分野のエンダウメント型財務経営に関心があり、起業準備中
